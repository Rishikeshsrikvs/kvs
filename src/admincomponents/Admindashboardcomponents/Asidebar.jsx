    ...
    <div className="sidebar">
      ...
      <div className="listcontainer">
        <ul>
          ...
          <li>
            <Link to="blogs"><span>Blogs</span><img src={blogicon} alt="" /></Link>
          </li>
          <li>
            <Link to="career"><span>Career</span><img src={careericon
            } alt="" /></Link>
          </li>
          <li>
            <Link to="projects"><span>Projects</span><img src={projecticon} alt="" /></Link>
          </li>
        </ul>
      </div>
    </div>
