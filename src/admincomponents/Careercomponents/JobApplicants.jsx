  ...
  useEffect(() => {
    const fetchJobAndApplicants = async () => {
      try {
        ...
        // Fetch applicants
        const applicantIds = jobResponse.data.applicantIds.map(
      ...
      {jobDetails && (
        <div className="job-details">
          ...
          <div className="jobdetailssub">
            ...
            <p>
              <strong>Experience Required:</strong> {jobDetails.experienceMin} -{" "}
              {jobDetails.experienceMax} years
            </p>
            <p>
              <strong>Salary:</strong> ${jobDetails.salaryMin} - $
            ...
            <p>
              ...
              {jobDetails.numberOfVacancies}
            </p>
            <p>
              <strong>Urgent Hiring:</strong>{" "}
              {jobDetails.urgentHiring ? "Yes" : "No"}
            </p>
          </div>
        </div>
      )}
      ...
      <ul>
        {applicants.map((applicant) => (
          <li key={applicant._id} className="applicantcon">
            ...
            <div>
              <button onClick={() => downloadResume(applicant._id)}>
                Download Resume
              </button>
            </div>
          </li>
