    ...
    <div className='aboutparentcontainer'>
      ...
      <div className="about2main">
        ...
        <div className='about2right'>
          <h1 className="a2color"><span className='a2colorline'></span><span>WHO WE ARE</span></h1>
          <p>Sri KVS Tech is one of the leading Digital marketing service companies in Chennai.</p>
          <p>We are more than just a Marketing agency – we're your digital partner in achieving your business goals. Our experts know all the techniques to help your business grow online.</p>
          <p>We provide the best online marketing services 
            <ul>
          ...
          <h1 className='about2rightlasth1'>“ Transform your online presence and boost your business with us today! ”</h1>
        </div>
      </div>
      <div className="about25main">
        ...
        <div className="a25cardcon">
          <div className="a25card1">
            ...
            <h1>Expertise :</h1>
            <p>With years of experience in the industry, we have the knowledge and skills to deliver results-driven digital marketing solutions that align with your business objectives.</p>
          </div>
          <div className="a25card2">
            ...
            <h1>Customization :</h1>
            <p>We understand that every business is unique. That's why we take a personalized approach to each client, crafting custom-made strategies that align perfectly with your business and objectives.</p>
          </div>
          <div className="a25card3">
            ...
            <h1>Transparency :</h1>
            <p>We believe in honest and open communication. Throughout the duration of our partnership, you'll have full visibility into the progress of your campaigns and access to detailed performance reports.</p>
          </div>
          <div className="a25card4">
            ...
            <p>Our ultimate goal is your success. Whether it's increasing brand awareness, driving website traffic, or boosting sales, we're committed to delivering measurable results that exceed your expectations.</p>
          </div>
        </div>
      </div>
      ...
      <div className="aboutyearcontainer">
        ...
        <div className="abyearssplit">
          <h1><AnimatedNumber value={50} duration="2000" /></h1>
          <h4>HAPPY CLIENTS</h4>
        </div>
        <div className="abyearssplit">
          <h1><AnimatedNumber value={4} duration="2000" />+</h1>
